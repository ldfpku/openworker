...
const FILE_WRITE_TOOLS = new Set(["write_file", "write_spreadsheet", "write_document", "apply_patch", "apply_unified_diff", "replace_in_file"]);
    ...
    const handleEvent = (ev: WsEvent) => {
      ...
      switch (ev.type) {
        ...
        case "tool_finished":
          ...
          break;
        case "turn_end":
          // Both gates report the same way, and the notice has to say what the turn cost and
          // that replying resumes it — an idle session is the expensive kind, because the
          // provider cache goes cold and resuming re-bills the whole prompt at full price.
