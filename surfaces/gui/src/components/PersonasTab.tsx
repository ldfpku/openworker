...
// VALID_GROUPS in step. Labels are i18n keys resolved at render time.
const GROUPS = [
  { id: "general", label: "personas.group_general" },
  { id: "operations", label: "personas.group_operations" },
  { id: "research", label: "personas.group_research" },
  { id: "security", label: "personas.group_security" },
] as const;
...
// Values are i18n keys resolved at render time. Exported for LibraryView's compact
// expert-install consent modal, which mirrors this same wording.
